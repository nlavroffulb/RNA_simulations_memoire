...
public:
	unbound_section(double prob, double weight, std::vector<std::vector<double>> position_vectors, bool rw);
	unbound_section(double prob, double weight, double U, bool rw);
	unbound_section(std::vector<int>& limits, std::vector<double>& weight_vals, std::vector<double>& U_values, bool rw);
	~unbound_section();
...
std::vector<std::vector<double>> rosenbluth_grow_chain(std::vector<double>& starting_end,
	...
	std::vector<std::vector<double>>& excluded_volumes, int trials, double& configuration_prob, unbound_section* section);
std::vector<std::vector<double>> rosenbluth_grow_chain(std::vector<double>& starting_end,
	std::vector<double>& ending_end, int l,
